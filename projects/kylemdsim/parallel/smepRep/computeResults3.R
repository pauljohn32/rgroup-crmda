...
### Compile some Results and Such ###

load("outMat-N125-PM50.RData")
...
#results1000pm10 <- results
#results1000pm30 <- results
#results1000pm50 <- results

#resList$results1000pm10 <- results1000pm10
#resList$results1000pm30 <- results1000pm30
#resList$results1000pm50 <- results1000pm50

#results500pm10 <- results
#results500pm30 <- results
#results500pm50 <- results

#resList$results500pm10 <- results500pm10
#resList$results500pm30 <- results500pm30
#resList$results500pm50 <- results500pm50

#results250pm10 <- results
#results250pm30 <- results
#results250pm50 <- results

#resList$results250pm10 <- results250pm10
#resList$results250pm30 <- results250pm30
#resList$results250pm50 <- results250pm50


#results125pm10 <- results
#results125pm30 <- results
#results125pm50 <- results

#resList$results125pm10 <- results125pm10
#resList$results125pm30 <- results125pm30
#resList$results125pm50 <- results125pm50
...
resList$result10Vec125 <- result10Vec125
resList$result30Vec125 <- result30Vec125
resList$result50Vec125 <- result50Vec125
...
#resList$result10Vec250 <- result10Vec250
#resList$result30Vec250 <- result30Vec250
#resList$result50Vec250 <- result50Vec250
...
#resList$result10Vec500 <- result10Vec500
#resList$result30Vec500 <- result30Vec500
#resList$result50Vec500 <- result50Vec500

#result10Vec1000 <- apply(results1000pm10,2,mean)
#result30Vec1000 <- apply(results1000pm30,2,mean)
#result50Vec1000 <- apply(results1000pm50,2,mean)

#resList$result10Vec1000 <- result10Vec1000
#resList$result30Vec1000 <- result30Vec1000
#resList$result50Vec1000 <- result50Vec1000


averagedResults125 <- rbind(result10Vec125,result30Vec125,result50Vec125)
resList$averagedResults125 <- averagedResults125

#averagedResults250 <- rbind(result10Vec250,result30Vec250,result50Vec250)
#resList$averagedResults250 <- averagedResults250

#averagedResults500 <- rbind(result10Vec500,result30Vec500,result50Vec500)
#resList$averagedResults500 <- averagedResults500

#averagedResults1000 <- rbind(result10Vec1000,result30Vec1000,result50Vec1000)
#resList$averagedResults1000 <- averagedResults1000

fitResults <- resList

save(fitResults,file="fitResultsList.RData")
...
chiPlot <- plot(c(10,30,50),averagedResults1000[,6],col="red",ylim=c(100,1200),main="Chi Squared by method and percent missing",xlab="Percent Missing",ylab="chi squared",type="b")
chiPlot <- points(c(10,30,50),averagedResults1000[,8],col="blue",type="b")
chiPlot <- points(c(10,30,50),averagedResults1000[,4],col="green",type="b")

cfiPlot <- plot(c(10,30,50),averagedResults1000[,12],col="red",ylim=c(.8,1),main="CFI by method and percent missing",xlab="Percent Missing",ylab="CFI",type="b")
cfiPlot <- points(c(10,30,50),averagedResults1000[,14],col="blue",type="b")
cfiPlot <- points(c(10,30,50),averagedResults1000[,10],col="green",type="b")

tliPlot <- plot(c(10,30,50),averagedResults1000[,18],col="red",ylim=c(.8,1),main="TLI by method and percent missing",xlab="Percent Missing",ylab="TLI",type="b")
tliPlot <- points(c(10,30,50),averagedResults1000[,20],col="blue",type="b")
tliPlot <- points(c(10,30,50),averagedResults1000[,16],col="green",type="b")

rmseaPlot <- plot(c(10,30,50),averagedResults1000[,24],col="red",ylim=c(0,.14),main="RMSEA by method and percent missing",xlab="Percent Missing",ylab="RMSEA",type="b")
rmseaPlot <- points(c(10,30,50),averagedResults1000[,26],col="blue",type="b")
rmseaPlot <- points(c(10,30,50),averagedResults1000[,22],col="green",type="b")

srmrPlot <- plot(c(10,30,50),averagedResults1000[,30],col="red",ylim=c(0,.12),main="SRMR by method and percent missing",xlab="Percent Missing",ylab="SRMR",type="b")
srmrPlot <- points(c(10,30,50),averagedResults1000[,32],col="blue",type="b")
srmrPlot <- points(c(10,30,50),averagedResults1000[,28],col="green",type="b")

chiDiffPlot <- plot(c(10,30,50),averagedResults1000[,2],col="red",ylim=c(300,400),main="Chi Squared Difference by method and percent missing",xlab="Percent Missing",ylab="Chi Squared Difference",type="b")
srmrPlot <- points(c(10,30,50),averagedResults1000[,3],col="blue",type="b")
srmrPlot <- points(c(10,30,50),averagedResults1000[,1],col="green",type="b")
